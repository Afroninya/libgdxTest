...
public abstract class NPC extends LivingEntity {
    ...
    public NPC(Game game, String name, float x, float y) {
        this(game, null, null, name, (short) 100, (short) 0, (short) 0, 0, 0, 0, 0, 16, 24);
    }

    public NPC(Game game, String spriteSheet, String initialSprite, String name, short health, short acceleration, short maxSpeed, int damage, int movement, float x, float y, int width, int height) {
